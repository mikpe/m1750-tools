/*
 * pthread_attr_getdetachstate - POSIX 16.2.1.
 *  
 * #include <pthread.h>
 ...
 * 
 * $Log: pthread_attr_getdetachstate.c,v $
 * Revision 1.1  1997/07/17 09:40:16  nettleto
 * Initial revision
 *
 */
...
/*
 * Gets the value of detachstate attribute from attr object
 */
int
