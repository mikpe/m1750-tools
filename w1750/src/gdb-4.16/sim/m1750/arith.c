        ...
        case ARI_ADD:
          {
            ...
            if ((lop0 & 0x8000L) == (lop1 & 0x8000L) &&
                (lop1 & 0x8000L) != (laccu & 0x8000L))
              {
                ...
                sim1750_info ("FIXOFL on ADD, op0=%ld op1=%ld res=%ld\n",
                      lop0, lop1, laccu);
              }
        ...
        elsecase ARI_SUB:
          {
            ...
            if ((lop0 & 0x8000L) != (lop1 & 0x8000L)
             && (lop0 & 0x8000L) != (laccu & 0x8000L))
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on SUB, op0=%ld op1=%ld res=%ld\n",
                    lop0, lop1, laccu);
              }
        ...
        elsecase ARI_MULS:
          {
            ...
            if (overflow)
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on MULS, op0=%ld op1=%ld res=%ld\n",
                      lop0, lop1, laccu);
              }
        ...
        elsecase ARI_DIV:
          {
            ...
            if (lop1 == 0L || (lop0 == 0x8000L && lop1 == 0xFFFFL))
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on DIV, op0=%ld op1=%ld res=%ld\n",
                      lop0, lop1, laccu);
              }
        ...
        elsecase ARI_DIVV:
          {
            ...
            if (lop1 == 0L || (lop0 == 0x8000L && lop1 == 0xFFFFL))
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on DIVV, op0=%ld op1=%ld res=%ld\n",
                      lop0, lop1, laccu);
              }
            else        /* Put this in an "else" part because */
              {         /* laccu and rem are otherwise undefined */
        ...
        case ARI_ADD:
          {
            ...
            if ((lop0 & 0x80000000LL) == (lop1 & 0x80000000LL)
             && (lop1 & 0x80000000LL) != (laccu & 0x80000000LL))
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on long ADD, op0=%lld op1=%lld res=%lld\n",
                    lop0, lop1, laccu);
              }
        ...
        elsecase ARI_SUB:
          {
            ...
            if ((lop0 & 0x80000000LL) != (lop1 & 0x80000000LL)
             && (lop0 & 0x80000000LL) != (laccu & 0x80000000LL))
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on long SUB, op0=%lld op1=%lld res=%lld\n",
                    lop0, lop1, laccu);
              }
        ...
        elsecase ARI_MUL:
          {
            ...
            if (overflow)
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on long MUL, op0=%lld op1=%lld res=%lld\n",
                    lop0, lop1, laccu);
              }
        ...
        elsecase ARI_DIV:
          {
            ...
            if (lop1 == 0LL ||
              ...
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on long DIV, op0=%lld op1=%lld res=%lld\n",
                    lop0, lop1, laccu);
              }
            else        /* Put this in an "else" part because */
        ...
        if (operation == ARI_ADD ? opsign = 1 :
          ...
          /* MUL or DIV */
          {
            ...
            if (ari_interrupt)
              {
                simreg.pir |= INTR_FIXOFL;
                sim1750_info ("FIXOFL on long %s,  op0=%ld op1=%ld res=%ld\n",
        ...
        if (overflow)
          {
            ...
            sim1750_info ("arith: FLT zero divide during %s,  op0=%g op1=%g res=%g\n",
        ...
        else
          {
            ...
            if (stat != 0)
              sim1750_info ("arith: FLT%cFL during %s,  op0=%g op1=%g res=%g\n",
                    (stat > 0 ? 'O' : 'U'),
                    operation_name[(int) operation], fop0, fop1, faccu);
